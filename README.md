...
- In the _Environment variables (advanced)_ section, add a new variable named `NODE_VERSION` set to `20` or greater, add new variables named `NEXT_PUBLIC_GRAPHQL_URI` and `NEXT_PUBLIC_API_URL`.
